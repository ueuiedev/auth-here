Imports CommunityToolkit.Uwp.Notifications
...
Namespace Services
    Friend Partial Class ToastNotificationsService
        Public Sub ShowToastNotificationSample()
            ...
            ' More about Toast Buttons at https://docs.microsoft.com/dotnet/api/CommunityToolkit.uwp.notifications.toastbutton
            ...
            ' More about the Launch property at https://docs.microsoft.com/dotnet/api/CommunityToolkit.uwp.notifications.toastcontent
